...
class AuctionUpdateRequest {
    constructor({
        ...
        this.title = title; // Auction title
        this.productUpdateRequest = productUpdateRequest; // An instance of ProductUpdateRequest
        this.startTime = startTime; // Auction start time
        this.endTime = endTime; // Auction end time
        this.currentPrice = currentPrice; // Current price of the auction
        this.startingPrice = startingPrice; // Starting price for the auction
        this.minimumBidIncrement = minimumBidIncrement; // Minimum bid increment for bids
        this.extensionCount = extensionCount; // Number of times the auction can be extended
    }
