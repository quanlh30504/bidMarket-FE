...
const SearchBox = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    if (handleValidation()) {
      window.location.href = `/search?title=${encodeURIComponent(inputValue)}`;
    }
  };
    ...
    <>
      <form className="">
        ...
        <div className="relative">
          ...
          />
          <PrimaryButton type={"button"} className={"absolute end-2.5 bottom-2"} onClick={handleSearch}>Search</PrimaryButton>
        </div>
