...
export const auctionData = [
  ...
  },
  {
    ...
    productDto: {
      id: 1,
      name: "Vintage Car",
      description: "A classic vintage car.",
      imageUrl: "https://example.com/vintage-car.jpg",
    },
    startTime: new Date().toISOString(),
    endTime: new Date(new Date().getTime() + 48 * 60 * 60 * 1000).toISOString(), // 48 hours from now
