                    ...
                    (list.id !== 7 || role === "SELLER") && (
                      <li key={list.id} className="capitalize list-none">
                        <CustomNavLinkList
                          ...
                          className={`${
                            isScrolled || (!isHomePage && !isChatPage)
                              ? "text-black"
                              : "text-white"
                          }`}
                        >
                      ...
                      {isDropdownOpen && (
                        <div className="absolute right-0 mt-2 w-48 bg-white border rounded shadow-lg">
                          ...
                          <button
                            ...
                            className="block w-full text-left px-4 py-2 text-black hover:bg-gray-200 text-[17px] font-medium cursor-pointer list-none hover:text-green transition-all ease-in-out "
                          >
                            Logout
                          </button>
                        </div>
