...
export const ShopView = () => {
  ...
  const handleFollow = async () => {
    try {
      await axiosClient.post(`/api/follows/${sellerId}/follow`, {
        params: { followerId: "010bb242-c6e1-403e-8bca-2825bd329861" } 
        });
                ...
                <ProfileCard>
                  ...
                  <div className='flex items-center gap-8 h-32'>
                   ...
                   <Caption>336 followers</Caption>
                    ...
                    {isFollowing ? (
                      <button className=" ms-8 w-24 px-2 py-1 text-sm border-2 rounded-full text-white border-green bg-green" onClick={handleUnfollow} > Follow</button>  
                      ) : (
                      <button className=" ms-8 w-24 px-2 py-1 text-sm border-2 rounded-full text-white border-green bg-green" onClick={handleFollow} > UnFollow</button>  
