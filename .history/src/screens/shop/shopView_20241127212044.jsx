...
export const ShopView = () => {
  ...
  const handleFollow = async () => {
    try {
      await axiosClient.post(`/api/follows/${sellerId}/follow`, { params: { followerId: "010bb242-c6e1-403e-8bca-2825bd329861" } });
  ...
  const handleUnfollow = async () => {
    try {
      await axiosClient.delete(`/api/follow`, { data: { sellerId: sellerId } });
