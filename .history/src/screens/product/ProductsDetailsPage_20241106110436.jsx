          ...
          <div className="flex justify-between gap-8">
            ...
            <div className="w-1/2">
              ...
              <Title className="flex items-center gap-2">
                Auction ends:
                <Caption>{auctionData.end_time}</Caption>
              </Title>
              <Title className="flex items-center gap-2 my-5">
                Timezone: <Caption>UTC 0</Caption>
              </Title>
              <Title className="flex items-center gap-2 my-5">
                Price:<Caption>${auctionData.starting_price} </Caption>
              </Title>
              <Title className="flex items-center gap-2">
                Current bid:<Caption className="text-3xl">${auctionData.current_price} </Caption>
              </Title>
