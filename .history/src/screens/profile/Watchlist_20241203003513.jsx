...
export const Watchlist = () => {
  ...
  const fetchProductDetails = async () => {
    try {
      ...
      // Set product details
      // Check if the product is in the watchlist
      const watchlistResponse = await axiosClient.get(`/api/watchlist/user/${authUtils.getCurrentUserId()}`);
      const watchlistItem = watchlistResponse.data.content.find(item => item.productId === id);
      if (watchlistItem) {
