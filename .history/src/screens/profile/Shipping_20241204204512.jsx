          ...
          {items.map((item, index) => (
            <tr key={index} className="bg-white border-b hover:bg-gray-50">
              ...
              <td className="px-6 py-4  text-center">
                 <div className={`inline-block w-24 px-2 py-1 text-sm border-2 rounded-full text-white ${item.status === 'PENDING' ? 'border-yellow bg-green' : 'border-red-500 bg-red-500'}  text-center truncate`}>
                  {item.status}
                 </div>
              </td>
            </tr>
