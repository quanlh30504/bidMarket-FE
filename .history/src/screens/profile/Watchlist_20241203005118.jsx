...
export const Watchlist = () => {
  ...
  const handleAuctionClick = (item) => {
    console.log("Auction clicked:", item);
    // Ví dụ: Chuyển hướng đến trang chi tiết đấu giá
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <Table items={watchlist} handleAuctionClick={handleAuctionClick}/> {/* Pass the current page items */}
...
const Table = ({ items, handleAuctionClick  }) => {
