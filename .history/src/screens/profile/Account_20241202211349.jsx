...
export const Account = () => {
  ...
  const handleEditClick = () => {
    ...
    setProfileData({
      ...
      email: accountInfo.contactDetails.email,
      phone: accountInfo.contactDetails.phone,
      streetAddress: accountInfo.personalInfo.address,
      city: accountInfo.personalInfo.city,
      country: accountInfo.personalInfo.country
    });
  };
          ...
          <div className="mt-4 capitalize w-full">
            <div className="flex justify-between border-b py-3">
              ...
              <div className="flex justify-between py-3 w-1/2">
                ...
                <NavLink to="" type="button" className="font-medium text-indigo-500" onClick={handleEditClick}>
                  <CiEdit size={25} />
                </NavLink>
              </div>
            </div>
