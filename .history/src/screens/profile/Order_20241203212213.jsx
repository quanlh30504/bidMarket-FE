        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500">
          ...
          <tbody>
            ...
            <td className="px-6 py-4">
              ...
              <td className="px-6 py-4  text-center">
                {item.status === "PENDING" && (
                  <div onClick={() => handlePayment(item.id)className="inline-block w-24 px-2 py-1 text-sm border-2 rounded-full text-black border-black-500 text-center truncate">Pay</div>
                )}    
              </td>
            </tr>
            ))}
