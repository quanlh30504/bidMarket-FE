      ...
      <div className="description-tab shadow-s3 p-8 rounded-md">
        ...
        <div className="flex justify-between gap-5">
          ...
          <div className="flex justify-between py-3">
            ...
            <NavLink to="" type="button" className="font-medium text-indigo-500" onClick={() => handleEditClick('email')}>
              <CiEdit size={25} />
            </NavLink>
          </div>
        )}
          ...
          <div className="flex justify-between py-3">
            ...
            <NavLink to="" type="button" className="font-medium text-indigo-500" onClick={() => handleEditClick('phoneNumber')}>
              <CiEdit size={25} />
            </NavLink>
          </div>
        )}
